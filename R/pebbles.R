...
pebble_colors <- c("#012e67",
  "#9cacbf",
  "#2b6684",
  "#032e42", "#0a1417")
tex_colors <- c("#253532", "#517f83", "#9e8d77", "#583d34", "#1f1b17")
...
tex_colored <- 
  ...
  mutate(size = sample(seq(0.03, 1.2, length.out = 100), size = nrow(.), replace = TRUE)) %>%
  group_by(id) %>%
