...
edges <- 20 # Number of edges of the original polygon
...
alph <- 0.2 # transparency of curves in geom_curve
angle <- 4.62 # angle of mid-segment with the edge
curv <- 0.9 # Curvature of curves
line_color <- "#d72631" # Color of curves in geom_curve
...
ggsave(here("Images/Circles.png"), bg = "black")
